...
import com.example.testtaskpexelsapp.databinding.BookmarksImagesListItemBinding
...
class BookmarksFragmentAdapter(
    private val imagePressedListener: IImagePressedListener,
    private val context: MainActivity):
    ListAdapter<ImageResourceFromPexels, BookmarksFragmentAdapter.ImageHolder>(AllImagesComparator()) {


    class ImageHolder(view: View): RecyclerView.ViewHolder(view) {
        private val binding = BookmarksImagesListItemBinding.bind(view)
        ...
        fun setData(image: ImageResourceFromPexels,
            ...
            binding.tvBookmarksNameSurname.text = image.photographer
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageHolder {
        val view = LayoutInflater
            .from(parent.context)
            .inflate(R.layout.bookmarks_images_list_item, parent, false)
